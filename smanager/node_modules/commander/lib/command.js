...
const { Argument, humanReadableArgName } = require('commander/lib/argument.js');
const { CommanderError } = require('commander/lib/error.js');
const { Help } = require('commander/lib/help.js');
const { Option, splitOptionFlags } = require('commander/lib/option.js');
const { suggestSimilar } = require('commander/lib/suggestSimilar');
