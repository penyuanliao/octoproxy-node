    ...
    startHeartbeat: function () {
        ...
        function lookoutdaemon() {
            ...
            if (daemon._lookoutEnabled == true) {
                ...
                out = setTimeout(function lookoutHandler() {
                    times++;
                    out = 0;
                    NSLog.log("info", "lookout Daemon(%s) try %s %s %s", daemon._modulePath,times ,">", doWait_maximum)
    ...
    send: function (message, handle, options, cb) {
        ...
        if (this._cpf && this._killed == false) {
            try {
                ...
                this._cpf.send(message, handle, options, () => {
