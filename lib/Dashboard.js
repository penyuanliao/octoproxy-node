...
Dashboard.prototype.recordAddress = function (host) {
    ...
    if (typeof this.octolog.income[host] == "number") {
        this.octolog.income[host] += 1;
    } else {
...
Dashboard.prototype.record = function (info) {
    ...
    if (typeof info.address != "undefined" && info.address.length > 12) {
...
Dashboard.prototype.IPAddressSort = function () {
    ...
    for (var i = 0; i < keysSorted.length; i++) {
        if (income[keysSorted[i]] > this.minCount) {
