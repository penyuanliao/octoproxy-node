...
function gameLBSrv(options) {
    ...
    this.glb_fork_d = new daemon(options.file,{silent:true,execArgv:["--nouse-idle-notification", "--max-old-space-size=" + options.moss]}); //心跳系統
 ...
 **/
gameLBSrv.prototype.getLoadBalancePath = function (url_args, host, cb) {
    var gameType;
    var h, r;
