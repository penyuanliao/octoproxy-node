...
FxTelegramBot.prototype.setChatID = function (chatID) {
    this.chatID = chatID;
};
...
FxTelegramBot.prototype.sendMessage = function (chatID, text, options) {
    const self = this;
    const chat_id = chatID || this.chatID;
    const parse_mode = (typeof options != "undefined") ? options.parse_mode : undefined;
