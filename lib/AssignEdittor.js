...
exports.editAssign = function (oAssign, obj, client) {
    ...
    try {
        ...
        if (typeof client != "undefined")
            this._writeException(client,this.ADMIN_EVENT_TYPE.SUCCESSFUL, "editAssign");
    }
    catch (e) {
...
exports.deleteAssign = function (name, client) {
    ...
    try {
        ...
        var saveData = JSON.stringify(conf, null, "\t").replace(",\n\t\t\tnull","");
...
exports.updateAssign = function (obj, client) {
    ...
    try {
        ...
        fs.writeFileSync(path, JSON.stringify(conf, null, "\t"));
        if (typeof client != "undefined")
            this._writeException(client,this.ADMIN_EVENT_TYPE.SUCCESSFUL, "updateAssign");
    }
    catch (e) {
        console.log('Configuation load file error:', e);
        if (typeof client != "undefined")
