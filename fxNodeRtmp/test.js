...
var obj = [ {a1: 'this a1',
    ...
    a4: 123 }];
/*
var data = Buffer.form([3,0,2,97,49,2,0,7,116,104,105,115,32,97,49,0,2,97,50,10,0,0,0,5,0,63,240,0,0,0,0,0,0,0,64,0,0,0,0,0,0,0,0,64,8,0,0,0,0,0,0,2,0,1,52,2,0,1,53,0,2,97,51,3,0,4,110,97,109,101,2,0,2,97,51,0,0,9,0,2,97,52,0,64,94,192,0,0,0,0,0,0,0,9])
log.logHex(data);
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
...
var buf = Buffer.alloc(s2.byteLength);
...
var rtmp = RTMPClient.connect('43.251.76.111',443, function() {
    ...
    var buf = Buffer.alloc(s1.byteLength + s2.byteLength + s3.byteLength);
...
//var test = Buffer.from([0x14,0,0, 155, 0, 0 ,26, 17, 0, 2, 0, 5, 108, 111,103, 105, 110, 0,0,0,0,0,0,0,0,0, 5,2,0,4,116,101,115,116]);
